# Building and installing Commsbus on GNU/Linux
Follow these steps in order to build (and install) Commsbus on GNU/Linux.

### Installing build dependencies
To build Commsbus you'll need to install the necessary development dependencies.
...
`../build/Commsbus_artefacts/Release/commsbus`. You can install it
